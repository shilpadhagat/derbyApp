...
app.proto.create = (model) ->
  ...
  @newTodoText = model.at '_page.newTodoText'
  @newTodoText1 = model.at '_page.newTodoText1'
...
app.proto.add = ->
  ...
  text = @newTodo.get()
  text2 = @newTodoText.get()
  text1 = @newTodoText1.get()
  ...
  todo = {group: groupName, completed: false, text: text, text1: text1,text2: text2}
